  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log('[Dashboard2] Updated recentData (last 12s):', latestDataArray.slice(0, 10));
        ...
        if (token && hours > 6) {
          ...
          try {
            const historyResponse = await fetch(`${process.env.REACT_APP_API_URL}/api/room2/history?hours=${hours}`, { headers });
        ...
        console.log('[Dashboard2] Updated chartData:', { labels: chartLabels, tempData, humidityData });
      } catch (error) {
      ...
      <div className="dashboard-container animate-fadeIn">
        ...
        <div className="w-full flex flex-col md:flex-row md:items-center md:justify-between gap-4 px-4 py-4 bg-gradient-to-r from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 shadow-lg border-b border-gray-200 dark:border-gray-700 mb-7">
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Room 2 Sensor Dashboard</h1>
            {isLive ? (
