...
function Dashboard1() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const latestResponse = await fetch(
          `${process.env.REACT_APP_API_URL}/api/room1`
        );
        ...
        console.log(
          "[Dashboard1] Updated recentData (last 12s):",
        ...
        if (token && hours > 6) {
          ...
          const recentResponse = await fetch(
            `${process.env.REACT_APP_API_URL}/api/room1/recent-history`
          );
        ...
        console.log("[Dashboard1] Updated chartData:", {
          labels: chartLabels,
          tempData,
          humidityData,
        });
    ...
    console.log("[Dashboard1] Mount: Starting polling every 30 seconds");
    fetchData();
